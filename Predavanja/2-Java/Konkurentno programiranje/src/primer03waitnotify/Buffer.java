...
public class Buffer {
  ...
  public synchronized int read() {
	 ...
	 * U slučaju da imamo više consumera, postoji mogućnost da će više
	 * njih biti u wait stanju. Onda notify() sa dna ove funkcije neće 
	 * probuditi producera (koji najverovatnije ni nije u wait stanju), 
	 * već će probuditi sledećeg consumera, a bafer je još uvek prazan.
