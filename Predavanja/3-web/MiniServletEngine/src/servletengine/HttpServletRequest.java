...
public class HttpServletRequest {
	...
	private ArrayList<Part> uploadedFiles = new ArrayList<Part>();
		...
		if (idx == -1) {
			...
			if (fileName != null) {
				...
				try {
					...
					uploadedFiles.add(new Part(fieldName, file
							.getAbsolutePath()));
				} catch (Exception ex) {
					ex.printStackTrace();
				}
	 ...
	 * 
	 * @param rdr
	 *            Stream od klijenta koji �emo iskoristiti da izvu�emo datoteke
	 *            koje se upload-uju.
	 * @param br
	 *            Reader koji �emo iskoristiti da izvu�emo parametre forme koji
	...
	/** �ita jedan red iz ulaznog toka do entera. */
	...
	/**
	 * �ita jedan red iz ulaznog toka i konvertuje string po zadatom encoding-u.
	 */
	...
	/** Objekat klase Session koji �uva podatke o trenutnoj sesiji. */
